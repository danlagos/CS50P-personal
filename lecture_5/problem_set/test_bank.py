...
def test_greeting_with_hello():
    ...
    assert value("hello") == 0, "Greeting starting with 'hello' should return 0"
...
def test_greeting_with_HELLOthere():
    ...
    assert value("HELLOthere") == 0, "Concatenated word starting with 'HELLO' should return 0"
...
def test_greeting_with_hello123():
    ...
    assert value("hello123") == 0, "String starting with 'hello' followed by numbers should return 0"
...
def test_greeting_with_hi():
    ...
    assert value("hi") == 20, "Greeting starting with 'h' but not 'hello' should return 20"

def test_greeting_with_H():
    # simulate greeting with "H", expect 20, "Single character 'H' should return 20"
    assert value("H") == 20, "Single character 'H' should return 20"
...
def test_greeting_with_howdy():
    ...
    assert value("howdy") == 20, "Greeting starting with 'h' but not 'hello' should return 20"
...
def test_greeting_with_Hi_there():
    ...
    assert value("Hi there!") == 20, "Greeting with 'h' and additional characters should return 20"
...
def test_greeting_with_good_morning():
    ...
    assert value("Good morning") == 100, "Greeting not starting with 'h' or 'hello' should return 100"

def test_greeting_with_empty_string():
    # simulate greeting with "", expect 100, "Empty string should return 100"
    assert value("") == 100, "Empty string should return 100"
...
def test_greeting_with_non_alphabetic_character():
    ...
    assert value("!") == 100, "String starting with non-alphabetic character should return 100"
...
def test_greeting_with_numbers_followed_by_hello():
    ...
    assert value("123hello") == 100, "String starting with numbers followed by 'hello' should return 100"
...
def test_greeting_with_leading_space_before_hello():
    ...
    assert value(" hello") == 100, "String with leading space before 'hello' should return 100"
